# Configuration for reading HepMC files into CMSSW GEN-SIM step
# This replaces the LHESource with a HepMCProduct source
# Based on HadronizerGENSIM but modified for HepMC input
...
# Input source - HepMC instead of LHE
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('HepMC input for DPS (J/psi+J/psi)+phi(1020) events'),
